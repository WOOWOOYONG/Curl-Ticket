## Purpose
Define how Curl Ticket UI text is translated across pages, components, and layouts while preserving stable underlying constant values in code and storage.
