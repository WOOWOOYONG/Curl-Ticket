...
This spec defines the requirements for permanently deleting an issue, covering API permissions, error handling, and the frontend delete UX with confirmation.
